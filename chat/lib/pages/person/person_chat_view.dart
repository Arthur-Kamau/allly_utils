import 'package:chat/core/user.dart';
import 'package:chat/database/db.dart';
import 'package:chat/model/operations_models/chat_model.dart';
import 'package:chat/model/operations_models/contact_model.dart';
import 'package:chat/pages/bottom_modal/chat_bottom_modal/chat_bottom_modal.dart';
import 'package:chat/pages/profile/user/public_profile.dart';
import 'package:chat/pages/transition/slide_right_transition.dart';
...
import 'package:chat/database/p2p_chat.dart';
/**
* int chat type
  *chat type
    0 => p2p
...
class P2PChatView extends StatefulWidget {
  ...
  P2PChatView({this.chatId, this.senderId, this.recepientId, this.phoneNumber});
...
//wait for message
  ...
  String _getSenderName() {
    ...
    for (var i = 0; i < dummyContacts.length; i++) {
      if (dummyContacts[i].userId == widget.senderId) {
        name = dummyContacts[i].name;
      }
    }
